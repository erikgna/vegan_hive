    ...
    <section className="flex h-screen">
      <div className="w-1/2 bg-gray-700 flex flex-col justify-center px-6">
        <h1 className="text-4xl font-semibold mb-4 text-white">
          O Melhor Espaço Para Se Cuidar
        </h1>
        ...
        <div className="flex">
          <button className="font-semibold bg-white text-gray-700 px-4 py-2 hover:bg-yellow-500 hover:text-white focus:outline-none focus:ring focus:border-yellow-300 mr-4 transition-all duration-300">
            Aprenda sobre nós
          </button>
          <button className="font-semibold text-white bg-transparent border border-white px-4 py-2 mr-4 hover:text-yellow-500 hover:border-yellow-500 focus:outline-none focus:ring focus:border-yellow-300 transition-all duration-300">
            Ver agenda
          </button>
        </div>
      </div>
      <form
        ...
        className="w-1/2 px-8 flex flex-col justify-center items-start"
      >
        <h1 className="text-3xl font-bold mb-3">Posturalle</h1>
        <p className="text-sm text-gray-600 mb-6">
          Acesse sua conta para agendar uma consulta
        </p>
