...
const ForgotPassword = () => {
    ...
    return <section className="flex min-h-screen">
        ...
        <form onSubmit={onRecoverPassword} className="w-full md:w-1/2 px-8 flex flex-col justify-center items-start">
            <div className="w-full flex flex-col items-center justify-center">
                ...
                <p className="text-md font-semibold text-gray-600 mb-6">
                    When you press recover password, you will receive an email with a link to reset your password
                </p>
            </div>
